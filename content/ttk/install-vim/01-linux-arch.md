+++
date = 2026-02-09
title = "Chapter 01: Installing Vim on Linux (Arch)"
description = "For young learners! Learn how to install Vim, your powerful text editor, on your Arch Linux computer using the terminal."
[taxonomies]
...
If you're using an Arch Linux computer, this chapter will show you how to
install Vim, your secret code-editing notebook!
...
Vim is usually found in your system's "app store" for commands, called `pacman`.
We'll use the `sudo` command to tell your computer you have permission to
...
Congratulations! Vim is now installed on your Arch Linux computer. Get ready to
learn its secrets!
...
- Next: [Chapter 02: Installing Vim on Windows](@/ttk/install-vim/02-windows.md)
