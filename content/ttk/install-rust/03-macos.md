...
Open your **Terminal** (you can find it in Applications > Utilities, or by
...
If the tools are not installed, a window will pop up asking you to install them.
Click "Install" and agree to the terms. This might take a little while. If you
...
developers use it! If you already have Homebrew, you can skip this step.
...
password. Press Enter when it asks you to.

After it's done, it might tell you to run a couple of commands to add Homebrew
...
After installation, it might tell you to "source" your `~/.profile` or
`~/.bashrc` or `~/.zshrc` file. This means reloading your Terminal's settings.
...
In your **new** Terminal window, type these commands, one by one, and press
Enter after each:
...
Congratulations! Rust is now installed on your macOS computer. You're ready to
