...
[Quoty](https://github.com/mxaddict/quoty) is a simple, blazing-fast Command-Line Interface (CLI) tool written in Rust that does one thing and does it well: it gives you a random, often insightful, programmer quote.
...
Since `quoty` is published on [crates.io](https://crates.io/crates/quoty), the easiest way to install it is with Cargo:

```bash
cargo install quoty
```

Alternatively, if you want to build from source, `quoty` is open source and available on my [GitHub repository](https://github.com/mxaddict/quoty). You can clone the repository and build it yourself:
