+++
date = 2026-03-11
title = "My Journey into Local AI Coding: From Zero to Using Ollama Qwen3-Coder:30b via Opencode on Home Hardware"
description = "Exploring my transition from traditional coding tools to setting up a local AI development environment using Ollama's Qwen3-Coder:30b model with opencode as the client."
[taxonomies]
...
I've been working with various coding tools throughout my career, but I've
always felt a bit uneasy about cloud-based solutions. The concerns were twofold:
first, the latency when using AI assistants in a network-connected environment,
...
What's also refreshing is having a consistent, fast experience without worrying
about internet connectivity. Even when traveling or working in areas with poor
network connections, I can continue coding with full AI assistance.
